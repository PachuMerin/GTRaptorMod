...
namespace GTRMod.Modules.BaseStates
{
    ...
    {
        public int vulcanIndex;

        protected string hitboxGroupName = "VulcanGroup";
        ...
        protected string playbackRateParam = "GTR-Kun_Shooting.playbackRate";
        ...
        {
            PlayCrossfade("Gesture, Override, Shoot", "GTR-Kun_Shooting" + (1 + vulcanIndex), playbackRateParam, duration, 0.05f);
        }
        ...
        public override void OnSerialize(NetworkWriter writer)
        {
            ...
            writer.Write(vulcanIndex);
        }

        public override void OnDeserialize(NetworkReader reader)
        {
            base.OnDeserialize(reader);
            vulcanIndex = reader.ReadInt32();
        }
